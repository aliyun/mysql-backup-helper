...
// NewDownloadProgressTrackerWithCompression creates a new progress tracker for download mode with compression
func NewDownloadProgressTrackerWithCompression(totalBytes int64, isCompressed bool) *ProgressTracker {
	pt := NewDownloadProgressTracker(totalBytes)
	pt.isCompressed = isCompressed
	return pt
}
